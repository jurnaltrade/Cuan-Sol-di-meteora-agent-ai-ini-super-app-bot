...
const FIELD_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "maxVolatility", label: "Max volatility (filter extreme)", type: "number", min: 0 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "repeatDeployCooldownTriggerCount", label: "Repeat deploy cooldown trigger count", type: "number", min: 1 },
      { key: "repeatDeployCooldownHours", label: "Repeat deploy cooldown hours", type: "number", min: 0 },
      { key: "repeatDeployCooldownScope", label: "Repeat deploy cooldown scope (pool/token/both)", type: "string" },
      { key: "repeatDeployCooldownMinFeeEarnedPct", label: "Repeat deploy min fee earned %", type: "number", min: 0 },
