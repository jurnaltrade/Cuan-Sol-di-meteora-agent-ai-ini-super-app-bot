...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      watchScore: ["risk", "watchScore"],
      normalSizeScore: ["risk", "normalSizeScore"],
      maxSizeScore: ["risk", "maxSizeScore"],
      minSizeMultiplier: ["risk", "minSizeMultiplier"],
      normalSizeMultiplier: ["risk", "normalSizeMultiplier"],
      maxSizeMultiplier: ["risk", "maxSizeMultiplier"],
      lossSizeMultiplier: ["risk", "lossSizeMultiplier"],
      lossCooldownHours: ["risk", "lossCooldownHours"],
      // schedule
